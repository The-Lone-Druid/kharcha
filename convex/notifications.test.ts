...
describe("Notifications API", () => {
  ...
  describe("listNotifications", () => {
    ...
    it("should return empty array for new user", async () => {
      ...
      const notifications = await asUser.query(
  ...
  describe("createNotification", () => {
    ...
    it("should create renewal notification", async () => {
      ...
      const notificationId = await asUser.mutation(
  ...
  describe("markAsRead", () => {
    it("should mark notification as read", async () => {
      ...
      // Verify unread
      let notifications = await asUser.query(
        api.notifications.listNotifications
      );
      expect(notifications).not.toBeNull();
    ...
    it("should not mark other user's notification as read", async () => {
      ...
      const notificationId = await asUser1.mutation(
        api.notifications.createNotification,
        {
          type: "renewal",
          transactionId,
  ...
  describe("deleteNotification", () => {
    it("should delete notification", async () => {
      ...
      await asUser.mutation(api.notifications.deleteNotification, {
        id: notificationId,
      });
    ...
    it("should not delete other user's notification", async () => {
      ...
      await expect(
        asUser2.mutation(api.notifications.deleteNotification, {
          id: notificationId,
        })
      ).rejects.toThrow();
    });

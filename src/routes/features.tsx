...
export const Route = createFileRoute("/features")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track expenses, manage subscriptions, and gain financial insights with Kharcha. Beautiful, fast, and works offline. Your personal finance companion." },
      { name: "keywords", content: "expense tracker, budget app, subscription manager, personal finance, money management, PWA, offline app" },
      // Open Graph
      { property: "og:type", content: "website" },
      { property: "og:title", content: "Kharcha - Smart Expense Tracking Made Beautiful" },
      { property: "og:description", content: "Track expenses, manage subscriptions, and gain financial insights. Beautiful, fast, and works offline." },
      { property: "og:image", content: "/og-image.png" },
      { property: "og:url", content: "https://kharcha.app/features" },
      // Twitter Card
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Kharcha - Smart Expense Tracking Made Beautiful" },
      { name: "twitter:description", content: "Track expenses, manage subscriptions, and gain financial insights. Beautiful, fast, and works offline." },
  ...
  const features = [
    {
      ...
      description: "Track cash, bank accounts, credit cards, UPI, and digital wallets all in one place.",
    ...
    },
    {
      ...
      description: "Never miss a subscription renewal or payment due date with intelligent notifications.",
      color: "from-purple-500 to-pink-500",
    },
    {
      icon: RefreshCw,
      title: "Subscription Tracking",
      description: "Automatically track recurring expenses and get projections for future costs.",
      color: "from-green-500 to-emerald-500",
    },
    {
      icon: Tags,
      title: "Custom Categories",
      description: "Create and customize expense categories to match your lifestyle.",
      color: "from-rose-500 to-red-500",
    },
    {
      icon: Download,
      title: "Export Data",
      description: "Export your transactions to CSV or Excel for detailed analysis.",
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
              The most beautiful expense tracker that works everywhere. 
              Manage your money, track subscriptions, and gain insights — all in one elegant app.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/">
                <Button size="lg" className="gap-2 text-lg px-8 py-6 bg-linear-to-r from-primary to-orange-600 hover:from-primary/90 hover:to-orange-600/90 shadow-xl shadow-primary/30 hover:shadow-primary/40 transition-all hover:scale-105">
                  Start Tracking Free <ArrowRight className="w-5 h-5" />
                </Button>
              </Link>
              <Button size="lg" variant="outline" className="gap-2 text-lg px-8 py-6 hover:bg-accent/50 transition-all" asChild>
                <a href="#features">
            ...
            <div className="relative mx-auto max-w-4xl">
              ...
              <div className="relative bg-linear-to-b from-card to-card/80 rounded-3xl border border-border/50 shadow-2xl shadow-black/10 dark:shadow-black/30 p-4 sm:p-8">
                ...
                <div className="flex items-center justify-between mb-4 px-2">
                  ...
                  <div className="text-xs text-muted-foreground font-mono">kharcha.app</div>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  <Card className="bg-linear-to-br from-primary/10 to-primary/5 border-primary/20">
                    <CardContent className="pt-6">
                      <div className="text-2xl sm:text-3xl font-bold text-primary">₹45,230</div>
                      <div className="text-sm text-muted-foreground">Total Balance</div>
                    </CardContent>
                  </Card>
                  <Card className="bg-linear-to-br from-green-500/10 to-green-500/5 border-green-500/20">
                    <CardContent className="pt-6">
                      <div className="text-2xl sm:text-3xl font-bold text-green-500">₹12,450</div>
                      <div className="text-sm text-muted-foreground">This Month</div>
                    </CardContent>
                  </Card>
                  <Card className="bg-linear-to-br from-blue-500/10 to-blue-500/5 border-blue-500/20">
                    <CardContent className="pt-6">
                      <div className="text-2xl sm:text-3xl font-bold text-blue-500">8</div>
                ...
                <div className="mt-6 space-y-3">
                  {[
                    { name: "Netflix", amount: "₹649", icon: "🎬", color: "text-red-500" },
                    { name: "Grocery Store", amount: "₹2,340", icon: "🛒", color: "text-green-500" },
                    { name: "Coffee Shop", amount: "₹180", icon: "☕", color: "text-amber-500" },
                  ].map((item, i) => (
                    <div 
                      key={i} 
              ...
              <div className="absolute -top-6 -left-6 p-4 bg-card rounded-2xl shadow-xl border border-border/50 animate-bounce" style={{ animationDuration: "3s" }}>
                <TrendingUp className="w-8 h-8 text-green-500" />
              </div>
              <div className="absolute -bottom-6 -right-6 p-4 bg-card rounded-2xl shadow-xl border border-border/50 animate-bounce" style={{ animationDuration: "3.5s", animationDelay: "0.5s" }}>
                <PieChart className="w-8 h-8 text-primary" />
              </div>
              <div className="absolute top-1/2 -right-10 sm:-right-16 p-3 bg-card rounded-xl shadow-xl border border-border/50 animate-pulse" style={{ animationDuration: "2s" }}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              ...
              <span className="bg-linear-to-r from-primary to-orange-600 bg-clip-text text-transparent"> Master Your Money</span>
            </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              ...
              >
                <CardHeader>
                  <div className={`w-14 h-14 rounded-2xl bg-linear-to-br ${feature.color} flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition-transform`}>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold mb-6">
                Built for <span className="bg-linear-to-r from-primary to-orange-600 bg-clip-text text-transparent">Real Life</span>
              </h2>
              <p className="text-muted-foreground mb-8 text-lg">
                Whether you're tracking daily coffee or managing multiple accounts, 
                Kharcha adapts to your lifestyle with powerful features that just work.
              </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Install on any device</p>
                    </div>
                  </div>
          ...
          <div className="bg-linear-to-br from-primary/10 via-orange-500/10 to-amber-500/10 rounded-3xl p-8 sm:p-16 border border-primary/20 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                ...
                <span className="bg-linear-to-r from-primary to-orange-600 bg-clip-text text-transparent"> Finances?</span>
              </h2>
              ...
              <Link to="/">
                <Button size="lg" className="gap-2 text-lg px-10 py-6 bg-linear-to-r from-primary to-orange-600 hover:from-primary/90 hover:to-orange-600/90 shadow-xl shadow-primary/30 hover:shadow-primary/40 transition-all hover:scale-105">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8 pt-6 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              Contributions welcome! Help us make expense tracking better for everyone.
            </p>
          </div>
        </div>
      </footer>

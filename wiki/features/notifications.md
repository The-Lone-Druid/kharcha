...
Kharcha keeps you informed about important financial events with a comprehensive notification system.
...
1. **Check Global Settings** - Ensure notifications are enabled in Settings
2. **Browser Permissions** - Make sure browser notifications are allowed
3. **Subscription Settings** - Verify the subscription has reminders enabled
4. **Time Zone** - Notifications are sent at 9:00 AM UTC

### Too Many Notifications?

1. **Fine-tune Preferences** - Disable specific notification types
2. **Adjust Subscription Settings** - Turn off reminders for individual subscriptions
3. **Global Toggle** - Disable all notifications temporarily
...
- **Review Weekly** - Check notification history regularly
- **Set Preferences** - Customize notifications to your needs
- **Mark as Read** - Keep your notification center clean

---

<p align="center">
  <a href="./settings.md">← Back to Settings</a> |

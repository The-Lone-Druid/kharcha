...
The Dashboard is your financial command center – a single view of your entire financial health.

---

## Overview

When you log in to Kharcha, the Dashboard is the first thing you see. It provides:
...
## Tips for a Healthy Dashboard

1. **Log transactions promptly** - The dashboard is only as accurate as your data
2. **Use all your accounts** - Include all spending sources
3. **Categorize correctly** - Proper categories = better insights
4. **Review regularly** - Make it a habit

---

<p align="center">
  <a href="./accounts.md">Accounts →</a>
</p>
